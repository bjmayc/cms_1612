		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					<div class="col-md-6">
						<img style="opacity: 1;width:400px;height:350px;" title="" class="medium" src="${path }/resources${product.pimage}">
					</div>
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">亿家价: <strong style="color:#ef0101;">￥：${product.shopPrice }/份</strong> 参 考 价： <del>￥${product.marketPrice }/份</del>
						</div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form action="${pageContext.request.contextPath}/addToCart.do" method="post">
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
								<a href="cart.htm">
									<input style="background: url('${path}/resources${product.pimage }') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="submit">
								</a> &nbsp;收藏商品
							</div>
							</form>
						</div>
				...
				<div style="width:950px;margin:0 auto;">
					...
					<div>
					<%-- 	<img src="${path }/resources${product.pimage}"> --%>
					</div>
